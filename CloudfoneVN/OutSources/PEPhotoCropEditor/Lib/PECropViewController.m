...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.image = appDelegate.cropAvatar;
...
- (void)done:(id)sender
{
    UIImage *cropImage = [AppUtil cropImageWithSize:CGSizeMake(500, 500) fromImage:self.cropView.croppedImage];
...
{
    self.title = [appDelegate.localization localizedStringForKey:@"Crop picture"];
    [_btnSave setTitle:[appDelegate.localization localizedStringForKey:@"Save"] forState:UIControlStateNormal];
}
